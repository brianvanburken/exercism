defmodule SpaceAge do
  ...
  @ratios [
    { :earth,  1.00000000 }, { :mercury, 0.24084670 }, { :venus,  0.61519726 },
    { :mars,   1.88081580 }, { :jupiter, 11.8626150 }, { :saturn, 29.447498  },
  ...
  for { planet, ratio } <- @ratios do
    def age_on(unquote(planet), seconds) do
      ( seconds / unquote(@year_in_seconds_on_earth) ) / unquote(ratio)
    end
  end
end
