...
defmodule Zipper do
  ...
  def from_tree(%BT{ value: v, left: l, right: r}), do: %Z{value: v, left: l, right: r, trail: []}

  @doc """
  Get the complete tree from a zipper.
  """
  @spec to_tree(Z.t) :: BT.t
  def to_tree(%Z{value: v, left: l, right: r, trail: t}), do: _to_tree(%BT{value: v, left: l, right: r}, t)
  defp _to_tree(b, []), do: b
  defp _to_tree(b, [{ :left, pv, pr } | pt]), do: do_to_tree(%BT{value: pv, left: b, right: pr}, pt)
  defp _to_tree(b, [{ :right, pv, pl } | pt]), do: do_to_tree(%BT{value: pv, left: pl, right: b}, pt)
  ...
  def up(%Z{ value: v, left: l, right: r, trail: [{ :left, pv, pr } | zt] }) do
    %Z{ value: pv, left: %BT{value: v, left: l, right: r}, right: pr, trail: zt }
  end
  def up(%Z{ value: v, left: l, right: r, trail: [{ :right, pv, pl } | zt] }) do
